...
import com.daybox.R;
import com.daybox.adapters.DashboardListAdapter;
import com.daybox.dto.DashboardListItemDTO;
import com.daybox.dto.MessageCustomDialogDTO;
import com.daybox.ui.SnackBar;
import com.daybox.util.NetworkCheck;
    ...
    private void populate() {
        ...
        if (null != bundle) {
            if (bundle.containsKey("done") && bundle.getString("done").equals("done")) {
                SnackBar.show(this, "Order has been placed !!");
            }
        }
...
/*
        ...
        dashboardListItemDTOs.add(dashboardListItemDTO);
        dashboardListItemDTO = new DashboardListItemDTO();
        dashboardListItemDTO.setTitle(getResources().getString(R.string.CurrentOrder));
        dashboardListItemDTO.setDesc(getResources().getString(R.string.CurrentOrderDesc));
...

                                             {
                                                 ...
                                                 public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                                     ...
                                                     switch (itemPosition) {
                                                         ...
                                                         case 1:
                                                             if (NetworkCheck.isNetworkAvailable(DashboardActivity.this)) {
                                                                 Intent intent = new Intent(DashboardActivity.this, PreviousOrdersActivity.class);
                                                                 startActivity(intent);
                                                             } else {
                                                                 MessageCustomDialogDTO messageCustomDialogDTO = new MessageCustomDialogDTO();
                                                                 messageCustomDialogDTO.setTitle(getResources().getString(R.string.login_activity_no_internet_title));
